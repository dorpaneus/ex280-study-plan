...
| 9  | **Obj 3 – Services, routes, scaling** | `03-deploy-applications.md` §4–6 | Lab 3.3–3.4 | Expose a service as HTTP route in 1 min |
...
| 20 | **Cross-objective lab** | — | "Onboard a new team": project template, quota, htpasswd users, group, route, NetworkPolicy | — |
